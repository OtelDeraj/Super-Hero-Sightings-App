...
public class SightingDBImpl implements SightingDao {
    ...
    public List<Sighting> getSightingsBySuperId(int id) throws SightingDaoException { // TODO add validation for all of these returning lists
        ...
        if(toReturn.size() == 0) throw new SightingDaoException("No sightings found for given Super ID");
        return toReturn;
    }
    ...
    public List<Sighting> getSightingsByLocId(int id) throws SightingDaoException {
        ...
        if(toReturn.size() == 0) throw new SightingDaoException("No sightings found for given Location ID");
        return toReturn;
    }
    ...
    public List<Sighting> getSightingsByDate(Date date) throws SightingDaoException {
        ...
        if(toReturn.size() == 0) throw new SightingDaoException("No sightings found for given Date");
        return toReturn;
    }
    ...
    public List<Sighting> getAllSightings() throws SightingDaoException {
        ...
        if(toReturn.size() == 0) throw new SightingDaoException("No sightings found");
        return toReturn;
    }

    @Override
    public Sighting addSighting(Sighting toAdd) throws SightingDaoException {
    ...
    @Override
    public void updateSighting(Sighting toEdit) throws BadUpdateException {
